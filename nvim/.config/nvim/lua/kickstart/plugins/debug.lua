...
return {
  ...
  config = function()
    ...
    end, { noremap = true, desc = '[D]ebug: [R]eset UI' })
    ...
    vim.keymap.set('n', '<leader>dm', require('dap-python').test_method, { desc = '[D]ebug: Test [M]ethod' })
    vim.keymap.set('n', '<leader>dC', require('dap-python').test_class, { desc = '[D]ebug: Test [C]lass' })
  end,
}
