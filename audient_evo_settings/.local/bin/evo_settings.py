...
# README: from https://github.com/vijay-prema/audient-evo-linux-tools
# Setup to run at startup with crontab entry:
# run `crontab -e` and add
# @reboot python3 ~/.local/bin/evo_settings.py &
...
dataFragment = b'\x00\xd0\xff\xff'
...
dataFragment = b'\x00\x21\x00\x00'
